...
const HeaderBanner = ({ heading }) => {
  return (
    <div className="max-w-[1920px] w-full mx-auto bg-[url('/img/Hero-bg.png')] bg-no-repeat bg-center bg-cover pb-5 sm:pb-[38px] md:pb-[48px] pt-5 sm:pt-10 md:pt-[50px] px-3">
